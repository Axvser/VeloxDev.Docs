...
- [命名空间：VeloxDev.MVVM.Serialization](03_mvvm-serialization/index.md) —— `ComponentModelEx` 工作流树 JSON 序列化。
- [关键成员契约](04_key-member-contracts/index.md) —— 顶层 API 的条目模板形式（签名 / 参数 / 返回值 / 异常 / 示例）。
