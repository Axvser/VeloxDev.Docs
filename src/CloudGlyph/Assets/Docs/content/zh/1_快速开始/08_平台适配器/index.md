...
- [00 前置条件](00_prerequisites/index.md) — 各适配器 `.csproj` 声明的目标框架、SDK/工作负载、演示
- [01 安装与引入依赖](01_install/index.md) — 七个适配器包与各自的模板包
- [02 配置 — 生成七个视图](02_setup/index.md) — 运行 `wpf-v-*` 项模板并查看每个文件接了什么
- [03 核心用法](03_core-usage/index.md) — 宿主表面、`ViewPool` 虚拟化、拖拽节点、连接槽、网格/小地图、主题接线
- [04 验证](04_verification/index.md) — 可观测结果与仓库内可运行的演示
- [05 完整代码](05_complete-code/index.md) — 精确的生成脚手架，每个源文件一页
