...
本页代码沿用 [03 构建画布](../03_build-canvas/index.md) 构建好的 `tree / source / report / discard`（类型见 [02 定义组件](../02_define-components/index.md)；最终单一文件见 [07 完整代码](../07_complete-code/index.md)）。
...
- `CompileRole.Terminal`：把节点当作**结果终端**，见 [05 终端结果编译](../05_terminal-compile/index.md)。
...
只算“一个节点的结果”而不需要起点节点？进入 [05 终端结果编译](../05_terminal-compile/index.md)。
