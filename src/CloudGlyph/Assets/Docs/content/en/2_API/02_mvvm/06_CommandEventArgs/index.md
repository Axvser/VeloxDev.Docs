...
| `EventType` | The current lifecycle state (`CommandEventType`, see [CommandEventType](../04_CommandEventType/index.md)). |
...
- `VeloxCommand` is the only producer; consumers subscribe through the `IVeloxCommand` lifecycle events (see [IVeloxCommand](../02_IVeloxCommand/index.md)) and read these properties.
