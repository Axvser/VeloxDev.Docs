...
Every adapter also overrides `InterpolatorCore.CreateScheduler` (see [01_abstractions](../../01_abstractions/index.md)). WPF, Avalonia and Jalium write it exactly like this:
