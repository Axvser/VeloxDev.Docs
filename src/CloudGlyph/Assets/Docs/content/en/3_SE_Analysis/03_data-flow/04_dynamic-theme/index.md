...
| [Switching](01_switching/index.md) | `Transition<T>` prepares grouped entries and runs them on one shared `TransitionTimeline` via `InterpolatorCore.CreateScheduler`; `Jump<T>` applies every end value directly. Guard conditions, degradation and cancellation paths |
