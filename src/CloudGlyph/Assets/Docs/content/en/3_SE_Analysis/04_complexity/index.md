...
|---|---|
| [00 Workflow System](00_workflow-system) | Spatial hash query, undo/redo, compile decomposition, serialize |
| [01 Workflow Agent](01_workflow-agent) | Auto-discovery scan, JSON snapshot diff, tool dispatch |
| [02 MVVM](02_mvvm) | Command queueing (semaphore), property notifications |
| [03 Transition](03_transition) | Interpolation per frame, scheduler fan-out |
...
| [08 Platform Adapters](08_platform-adapters) | View pool reuse, minimap projection |
