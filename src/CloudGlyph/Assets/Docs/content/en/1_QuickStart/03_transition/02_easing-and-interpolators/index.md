...
**Every family is drawn.** [Easing curves](00_easing-curves/index.md) has one chart per family — its `In`, `Out` and `InOut` together — plus all ten `Out` curves on a single axis for comparison.
